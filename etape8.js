window.onload = function() {
    ...
    let blockSize = 30;
    let ctx;
    let delay = 150; //1000 milliseconde = 1sd
    // let xCoord = 0;
    // let yCoord = 0;
    let snakee;
    let applee;
    ...
    function refreshCanvas() { //change la position du rectangle. On l'efface et on en crée un autre qui change de position
        ...
        ctx.clearRect(0, 0, canvasWidth, canvasHeight); //efface l'ancien rectangle(serpent) à chaque rafraichissement
        drawScore();
        snakee.draw();
        applee.draw();
    ...
    function gameOver(){
        ...
        // affichage "Appuyer sur la touche Espace pour rejouer"
